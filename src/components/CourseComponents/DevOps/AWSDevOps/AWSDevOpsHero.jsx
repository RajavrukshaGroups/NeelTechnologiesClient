        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p>
              ...
              with our comprehensive AWS-DevOps training. Through live
              instructor-led sessions, you'll learn how to design, deploy,
              and manage secure, scalable, and fault-tolerant applications
              on{" "}
            ...
            <p>
              ...
              , and more. You’ll gain hands-on experience through practical
              labs and real-world projects, enabling you to build robust
              DevOps pipelines and cloud-native architectures.
            </p>
            ...
            {expanded && (
              <>
                <p>
                  Learn how to implement CI/CD automation, infrastructure as
                  code (IaC), monitoring, logging, and high-availability
                  strategies using AWS best practices.
                </p>

                <p>
                  This certification prepares you for high-demand roles such
                  as{" "}
                  <span className="font-semibold text-[#FF9900]">
